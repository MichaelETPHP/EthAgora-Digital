  ...
  return (
    <section className={`relative ${height} overflow-hidden flex items-center justify-center`}>
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-20 right-20 w-48 h-48 bg-orange-500/20 rounded-full blur-3xl animate-float" style={{ animationDelay: '2s' }}></div>
        <div className="absolute bottom-10 left-1/3 w-40 h-40 bg-orange-400/15 rounded-full blur-3xl animate-float" style={{ animationDelay: '4s' }}></div>
        
        {/* Floating particles */}
        <div className="absolute top-1/4 left-1/4 w-2 h-2 bg-white/60 rounded-full animate-float" style={{ animationDelay: '0.5s' }}></div>
        <div className="absolute top-3/4 right-1/3 w-3 h-3 bg-orange-300/80 rounded-full animate-float" style={{ animationDelay: '1.5s' }}></div>
        <div className="absolute top-1/2 left-1/6 w-1 h-1 bg-orange-400/70 rounded-full animate-float" style={{ animationDelay: '2.5s' }}></div>
      </div>
      
      {/* Content */}
      <div className="relative z-10 text-center max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-4xl lg:text-6xl font-heading font-bold text-white leading-tight mb-6 animate-fade-in-up">
          {title}
        </h1>
