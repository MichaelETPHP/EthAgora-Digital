      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex items-center">
            <Link to="/" className="flex items-center space-x-3 group">
              ...
              <div className="flex flex-col">
                <span className="text-xl font-heading font-bold text-orange-600 group-hover:text-orange-700 transition-colors duration-300">
                  EthAgora
                </span>
                <span className="text-xs font-medium text-neutral-600 group-hover:text-neutral-700 transition-colors duration-300">
                  DIGITAL SOLUTIONS
                </span>
              </div>
            </Link>
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-8">
              {navigation.map((item) => (
                ...
                >
                  {item.name}
                  <span className={`absolute bottom-0 left-1/2 transform -translate-x-1/2 w-1 h-1 bg-orange-500 rounded-full transition-all duration-300 ${
          ...
          <div className="hidden md:block">
            <Link
              to="/contact"
              className="relative inline-flex items-center px-8 py-3 bg-gradient-to-r from-orange-500 via-orange-600 to-orange-700 text-white font-semibold rounded-full hover:shadow-[0_0_20px_rgba(249,115,22,0.4)] transition-all duration-300 transform hover:scale-105 overflow-hidden group"
            >
        ...
        {isMenuOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 bg-white/95 backdrop-blur-md border-t border-neutral-200 rounded-b-3xl shadow-lg">
              ...
              <Link
                to="/contact"
                className="block px-3 py-2 mt-4 bg-gradient-to-r from-orange-500 via-orange-600 to-orange-700 text-white text-center rounded-2xl font-medium hover:shadow-[0_0_20px_rgba(249,115,22,0.4)] transition-all duration-300"
                onClick={() => setIsMenuOpen(false)}
              >
                Get Started
              </Link>
