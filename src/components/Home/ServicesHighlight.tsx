  ...
  const services = [
    {
      ...
      details: {
        overview:
          'Our digital marketing and brand strategy services help businesses establish a strong online presence and connect with their target audience effectively.',
        features: [
          ...
          'competitors’ analysis and market research On the benefits side, add, Empowers smarter business decisions ',
        ],
        benefits: [
    ...
    },
    {
      ...
      details: {
        overview:
          'We specialize in creating impactful public health communication campaigns that educate communities and promote positive behavior change for better health outcomes.',
        features: [
    ...
    },
    {
      ...
      details: {
        overview:
          'Our strategic communication planning services ensure your message reaches the right audience at the right time through the most effective channels.',
        features: [
    ...
    },
    {
      ...
      details: {
        overview:
          'We provide comprehensive analysis of your digital campaigns, offering actionable insights to improve performance and maximize your return on investment.',
        features: [
        ...
        <div className='bg-white rounded-3xl max-w-4xl w-full max-h-[90vh] overflow-y-auto shadow-2xl animate-scale-in'>
          ...
          <div className='p-8'>
            ...
            <div className='mt-8 text-center'>
              <button
                className='inline-flex items-center px-8 py-4 font-semibold rounded-full transition-all duration-300 transform hover:scale-105'
                style={{ backgroundColor: '#f6971f', color: '#fff' }}
                onClick={() => {
                  onClose()
                  navigate('/contact')
      ...
      <div className='relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='text-center mb-16 animate-fade-in-up'>
          ...
          <p className='text-xl text-neutral-600 max-w-3xl mx-auto leading-relaxed'>
            ...
            services, engage your audience, and drive meaningful business
            results.
          </p>
        </div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
          {services.map((service, index) => (
            ...
            >
              ...
              <div
                className={`absolute inset-0 bg-gradient-to-r ${service.gradient} opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-3xl`}
              ></div>
              <div className='absolute inset-[1px] bg-white rounded-3xl'></div>

              <div className='relative z-10'>
                <div
                  className='inline-flex p-4 rounded-2xl mb-6 group-hover:shadow-glow-orange transition-all duration-300'
                  style={{ backgroundColor: '#f6971f' }}
                >
                  <service.icon className='h-8 w-8 text-white' />
                </div>
                ...
                <div className='flex items-center text-orange-600 font-medium group-hover:text-orange-700 transition-colors duration-300'>
                  Learn more
                  <div className='ml-2 h-4 w-4 group-hover:translate-x-2 transition-transform duration-300'>
                    →
                  </div>
                </div>
              </div>
