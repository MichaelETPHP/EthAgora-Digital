...
import { Target, Heart, MessageSquare, BarChart3, CheckCircle, ArrowRight } from 'lucide-react';
          ...
          <div className="space-y-20">
            {services.map((service, index) => (
              ...
              >
                ...
                <div className={`animate-fade-in ${index % 2 === 1 ? 'lg:col-start-1' : ''}`} style={{ animationDelay: '0.2s' }}>
                  <div className={`${service.bgColor} rounded-2xl p-8 shadow-lg`}>
                    <img
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 animate-fade-in-up">
            ...
            <p className="text-xl text-neutral-600 max-w-3xl mx-auto leading-relaxed">
              Select the perfect plan for your business needs. All packages include our 
              core services with varying levels of support and features.
            </p>
          </div>
              ...
              >
                ...
                <div className="text-center mb-8">
                  ...
                  <div className="flex items-baseline justify-center mb-4">
                    ...
                    {pkg.period && <span className="text-neutral-600 ml-1">{pkg.period}</span>}
                  </div>
      ...
      <section className="py-20 bg-orange-500">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-orange-100 mb-8 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
            Let's discuss which service package is right for your business goals.
          </p>
